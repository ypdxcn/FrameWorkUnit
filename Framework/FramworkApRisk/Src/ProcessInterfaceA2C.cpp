...
CProcessInterfaceA2C::GessPktInfo CProcessInterfaceA2C::m_GessPktInfo = 
{
...
int CProcessInterfaceA2C::OnPacket(char * pData, size_t nSize)
{
	...
	CRLog(E_PROINFO,"A2C %s",GessPacket.Print().c_str());
...
/*
int CProcessInterfaceA2C::OnSend(int nSize)
{
	return 0;
}
*/
...
//收到Hello后处理
int CProcessInterfaceA2C::OnHello(CTradePacket& GessPacket)
{
