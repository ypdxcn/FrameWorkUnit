#ifndef _PROCESS_INTERFACE_BSMSC_H
#define _PROCESS_INTERFACE_BSMSC_H
...
class COMMAPRISK_CLASS CProcessInterfaceSmscService :public CProcessInterfaceClnNm// public CTcpShortProcess
{
public:
	CProcessInterfaceSmscService(void);
	~CProcessInterfaceSmscService(void);
